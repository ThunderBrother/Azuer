...
+(id)managerWithCoreDataPath:(NSString*)path {
    ...
    [defaultPSC MR_addSqliteStoreNamed:path withOptions:@{NSMigratePersistentStoresAutomaticallyOption:@(true), NSInferMappingModelAutomaticallyOption:@(true)}];
...
- (void)deleteWithManageObject:(NSManagedObject *)object complite:(void (^ _Nullable)(BOOL, NSError * _Nullable))complite
{
    [MagicalRecord saveWithBlock:^(NSManagedObjectContext * _Nonnull localContext) {
