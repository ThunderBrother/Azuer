...
+ (instancetype)modelWithUrlString:(NSString*)destinationUrlString
    ...
    if ([scheme isEqualToString:context.routerScheme]) {
        item = [self routerModelWithKey:host option:OTSRouterPush data:nil];
    } else if([scheme isEqualToString:context.handlerScheme]) {
        item = [self handlerModelWithKey:host param:nil];
    } else if([scheme isEqualToString:context.actionScheme]) {
        item = [self actionModelWithOption:0 data:nil];
    }
...
+ (instancetype)alertWithTitle:(NSString*)title
    ...
    return [self alertWithTitle:title message:msg cancelTitle:cancelTitle positiveTitle:positiveTitle type:OTSActionOptionShowAlert eventBlock:eventBlock];
}
...
+ (instancetype)actionSheetWithTitle:(nullable NSString*)title
    ...
    return [self alertWithTitle:title message:msg cancelTitle:cancelTitle positiveTitle:positiveTitle type:OTSActionOptionShowSheet eventBlock:eventBlock];
}
...
+ (instancetype)alertWithTitle:(NSString*)title
    ...
    [extraData safeSetObject:positiveTitle ? @[positiveTitle] : nil forKey:OTSActionValues];
