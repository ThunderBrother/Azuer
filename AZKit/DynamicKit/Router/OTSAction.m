...
- (void)__submitActionWithCompletion:(void (^)(void))completionBlock {
    ...
    } else if (self.option & (OTSActionOptionHeaderSuccessfully | OTSActionOptionFooterSuccessfully | OTSActionOptionHeaderError | OTSActionOptionFooterError | OTSActionOptionFooterPause)) {
    ...
    } else if (self.option & OTSActionOptionShowEmpty) {
        [self.source.view showEmptyViewWithTitle:self.extraData[OTSIntentMessageKey] image:self.extraData[OTSIntentImageNameKey]];
    } else if (self.option & OTSActionOptionHideEmpty) {
        [self.source.view hideAllEmptyView];
    }
    ...
    if (self.option & (OTSActionOptionShowAlert | OTSActionOptionShowSheet)) {
        [self __executeAlertCommandWithCompletion:completionBlock];
    } else if(self.option & OTSActionOptionShare) {
        [self __executeShareCommandWithCompletion:completionBlock];
    } else if(self.option & OTSActionOptionDismiss) {
        [self __executeDismissCommandWithCompletion:completionBlock];
    }
    
}

- (void)__executeShareCommandWithCompletion:(void (^)(void))completionBlock {
...
- (void)__executeDismissCommandWithCompletion:(void (^)(void))completionBlock {
...
- (void)__executeAlertCommandWithCompletion:(void (^)(void))completionBlock {
