...
- (UICollectionView*)collectionView {
    if (!_collectionView) {
        ...
        Class defaultCollectionViewCellClass = [OTSCollectionViewCell class];
        
        [_collectionView registerClass:defaultCollectionViewCellClass forCellWithReuseIdentifier:@"OTSCollectionViewCell"];
        ...
        for (NSString *codeClassName in codeCellClassArray) {
            ...
            [_collectionView registerClass:([cellClass isSubclassOfClass:defaultCollectionViewCellClass] ? cellClass : defaultCollectionViewCellClass) forCellWithReuseIdentifier:codeClassName];
        }
        ...
        Class defaultHeaderFooterClass = [OTSCollectionReusableView class];
        
        NSArray *codeHeaderClassArray = [self codeHeaderClassNames];
        for (NSString *codeClassName in codeHeaderClassArray) {
            Class cellClass = NSClassFromString(codeClassName);
            [_collectionView registerClass:([cellClass isSubclassOfClass:defaultHeaderFooterClass] ? cellClass : defaultHeaderFooterClass) forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:codeClassName];
        }
        ...
        for (NSString *codeClassName in codeFooterClassArray) {
            Class cellClass = NSClassFromString(codeClassName);
            [_collectionView registerClass:([cellClass isSubclassOfClass:defaultHeaderFooterClass] ? cellClass : defaultHeaderFooterClass) forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:codeClassName];
        }
