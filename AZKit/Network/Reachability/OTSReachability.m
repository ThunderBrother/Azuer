...
{
    OTSLogI(@"New Radio Access Technology: %@", status);
    //2g,2.5g
...
- (void)dealWithReachabilityStatus:(AFNetworkReachabilityStatus)status {
    switch (status) {
        case AFNetworkReachabilityStatusNotReachable:
            OTSLogI(@"NotReachable notify recieved!");
            self.currentNetStatus = kConnectToNull;
            break;
        case AFNetworkReachabilityStatusReachableViaWWAN:
                OTSLogI(@"ReachableViaWWAN notify recieved!");
                self.currentNetStatus = kConnectToWWAN;
            break;
        case AFNetworkReachabilityStatusReachableViaWiFi:
            OTSLogI(@"ReachableViaWiFi notify recieved!");
